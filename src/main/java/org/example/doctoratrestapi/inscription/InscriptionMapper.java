...
import org.example.doctoratrestapi.inscription.dto.CandidatInscriptionCreationDto;
import org.example.doctoratrestapi.inscription.dto.CandidatInscriptionDto;
...
public class InscriptionMapper {
    ...
    public CandidatInscriptionDto toDto(InscriptionModel inscriptionModel) {
        ...
        return new CandidatInscriptionDto(cne, cin, nomCandidatArabe, prenomCandidatArabe,
                dateDeposerDossier, remarque, valider, titre, description, publier
                );
    }
