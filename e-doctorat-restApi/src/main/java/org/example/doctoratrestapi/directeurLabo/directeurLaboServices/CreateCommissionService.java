...
import org.example.doctoratrestapi.laboratoire.LaboratoireRepository;
...
public class CreateCommissionService {
    ...
    public CommissionDTO addCommission(CommissionCreationDto dto){
        ...
        Optional<LaboratoireModel> laboratoire =  laboRepo.findById(dto.laboId());
        ...
        List<ProfesseurModel> professeurs = fetchAndValidateProfesseurs(dto.profIds());
